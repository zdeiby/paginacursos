        ...
        <div className="bg-dark">
            ...
            <div className="container ">
                <div className="mx-auto estilo">
                    ...
                    <ColorCard nombre={(nameCourses && nameCourses.includes('sql'))?'Continua con el curso':'Añade Curso'} color='primary' brand='sql' name='Bases de datos SQL (NUEVO)' text='Prepárate aprender bases de datos relacionales desde cero, con muy buena tematica, registrate gratis' ></ColorCard>   
