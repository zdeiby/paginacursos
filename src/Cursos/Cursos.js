        ...
        <div className="bg-dark">
            ...
            <div className="container ">
                <div className="mx-auto estilo">
                    ...
                    <ColorCard nombre={(nameCourses && nameCourses.includes('SQL'))?'Continua con el curso':'Añade Curso'} color='primary' name='Bases de datos SQL (NUEVO)' text='Prepárate aprender bases de datos relacionales desde cero, con muy buena tematica, registrate gratis' ></ColorCard>   
